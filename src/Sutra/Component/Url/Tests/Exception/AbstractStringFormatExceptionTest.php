<?php
namespace Sutra\Component\Url\Tests\Exception;

use Sutra\Component\Url\Tests\TestCase;

class AbstractStringFormatExceptionTest extends TestCase
{
    const ABSTRACT_EXCEPTION_CLASS = 'Sutra\Component\Url\Exception\AbstractStringFormatException';
