<?php
namespace Sutra\Component\Date\Tests\Exception;

use Sutra\Component\Date\Tests\TestCase;

class AbstractStringFormatExceptionTest extends TestCase
{
    const ABSTRACT_EXCEPTION_CLASS = 'Sutra\Component\Date\Exception\AbstractStringFormatException';
